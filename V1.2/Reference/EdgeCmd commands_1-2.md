...
EdgeCmd command| Description | Example |
---------------|-------------|----------|
`edgecmd get Application [-file <filepath>]` | Display the configuration for every platform component. | `edgecmd get Application`
`edgecmd set Application -file <filepath>` | Import the entire configuration for the platform. | `edgecmd set Application -file C:\Users\TestUser\Adapter\Configuration.json`
`edgecmd reset Application`  | Reset the entire application and storage in EDS. | 
`edgecmd help Application` | Display help output for the entire application.
...
EdgeCmd command| Description | Example |
---------------|-------------|----------|
`edgecmd get Components [-file <filepath>]` | Display system component configuration. | `edgecmd get Components`
`edgecmd set Components [-file <filepath>]` | Import system component configuration. | `edgecmd set Components -file C:\Users\TestUser\Components\Configuration.json`
`edgecmd add Components [-type <type>] [-id <componentId>]`  | Add component to the system configuration. | `edgecmd add Components  -type Modbus -id Modbus1`
`edgecmd remove Components [-id <componentId] [-y]` | Remove specified component from system configuration. | `edgecmd remove Components -id Modbus1`
`edgecmd help Components`| Display help output for component configuration. |

### Buffering facet configuration

EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get Buffering [-file <filepath>]` | Display system buffering configuration. | `edgecmd get Buffering C:\Users\TestUser\Buffering\Configuration.json`
`edgecmd set Buffering [-file <filepath>]` | Import system buffering configuration. | `edgecmd set Buffering`
`edgecmd edit Buffering [-bufferLocation <value>] [-maxBufferSizeMB <value>] [-enableBuffering <value>]`  | Change system buffering configuration. | `edgecmd Buffering -bufferLocation C:/ProgramData/OSIsoft/Adapters/Modbus/Buffers -maxBufferSizeMB 1024 -enableBuffering true`
`edgecmd help Buffering` | Display help output for system buffering configuration.

### Health endpoints facet configuration

EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get HealthEndpoints [-file <filepath>]` | Display system health endpoints configuration. | `edgecmd get HealthEndpoints `
`edgecmd set HealthEndpoints [-file <filepath>]` | Import system health endpoints configuration. | `edgecmd set HealthEndpoints -file C:\Users\TestUser\HealthEndpoints\Configuration.json`
`edgecmd add HealthEndpoints [-id <string>] [-Endpoint <endpointUrl>] [-UserName <userName>] [-Password <password>] [-ClientId <clientId>] [-ClientSecret <clientSecret>] [-TokenEndpoint <tokenEndpoint>] [-ValidateEndpointCertificate <true/false>]`  | Add a health endpoint to the system. | `edgecmd add HealthEndpoints -id OCS -Endpoint https://OCS_OMF_endpoint -ClientId TestUser -ClientSecret TestPassword`
`edgecmd edit HealthEndpoints [-id <string>] [-Endpoint <endpointUrl>] [-UserName <userName>] [-Password <password>] [-ClientId <clientId>] [-ClientSecret <clientSecret>] [-TokenEndpoint <tokenEndpoint>] [-ValidateEndpointCertificate <true/false>]` | Change a system health endpoint. | `edgecmd edit HealthEndpoints -id OCS -Endpoint https://OCS_OMF_endpoint -ClientId TestUser -ClientSecret TestPassword`
`edgecmd remove HealthEndpoints [-id <string>] [-y]`| Remove system health endpoint. | `edgecmd remove HealthEndpoints -id OCS`
`edgecmd help HealthEndpoints` | Display help output for system health endpoints configuration.

## OmfEgress data endpoints facet configuration

EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get DataEndpoints [-file <filepath>]` | Display system data endpoints configuration. | `edgecmd get DataEndpoints`
`edgecmd set DataEndpoints [-file <filepath>]` | Import system data endpoints configuration. | `edgecmd set DataEndpoints -file C:\Users\TestUser\DataEndpoints\Configuration.json`
`edgecmd add DataEndpoints [-id <endpointId>] [-Endpoint <endpointUrl>] [-UserName <userName>] [-Password <password>] [-ClientId <clientId>] [-ClientSecret <clientSecret>] [-TokenEndpoint <tokenEndpoint>] [-ValidateEndpointCertificate <true/false>]`  | Add data endpoints to the system. | `edgecmd add DataEndpoints -id PI Web Api  -Endpoint https://pi_web_api_server/piwebapi/omf/ -UserName TestUser -Password TestPassword -ValidateEndpointCertificate false` 
`edgecmd edit DataEndpoints -id <string> [-Endpoint <endpointUrl>] [-UserName <userName>] [-Password <password>] [-ClientId <clientId>] [-ClientSecret <clientSecret>] [-TokenEndpoint <tokenEndpoint>] [-ValidateEndpointCertificate <true/false>]` | Change a system data endpoint. | `edgecmd edit DataEndpoints -id PI Web Api -Endpoint https://pi_web_api_server/piwebapi/omf/ -UserName TestUser -Password TestPassword -ValidateEndpointCertificate true` |
`edgecmd remove DataEndpoints -id <string> [-y]`| Remove specified system data endpoint. | `edgecmd remove DataEndpoints -id PI Web API`
`edgecmd remove DataEndpoints [-y]`| Remove all system data endpoints. | `edgecmd remove DataEndpoints -y`
`edgecmd help DataEndpoints`| Display help output for system data endpoints configuration.
...
EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get -cid <componentId> [-file <filepath>]` | Display configuration of specified component. | `edgecmd get -cid OpcUa1`
...
EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get Logging [-cid <componentId>] [-file <filepath>]` | Display logging configuration for specified component. | `edgecmd get Logging -cid Modbus1`
...
EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get Schedules -cid <componentId> [-file <filepath>]` | Display schedules configuration for specified component. | `edgecmd get Schedules -cid Modbus1`
...
EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get DataFilters -cid <componentId> [-file <filepath>]` | Display data filters configuration for specified component. | `edgecmd get DataFilters -cid OpcUa1`
...
EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get DataSource -cid <componentId>` | Display data source configuration for specified component. | `edgecmd get DataSource -cid OpcUa1`
...
EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get <FacetName> -cid <componentId> [-file <filepath>]` | Display configuration for specified facet in specified component. | `edgecmd get Logging -cid Modbus1`
...
EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get Storage` | Display Storage configuration. |
...
`edgecmd edit Storage [-<parameter> <value>]`  | Change Storage configuration. | `edgecmd edit Storage`
...
EdgeCmd command| Description | Examples |
---------------|-------------|----------|
`edgecmd get Runtime` | Display runtime configuration. | 
...
---------------|-------------|
`edgecmd get Diagnostics` | Display diagnostics configuration. | 
`edgecmd get Version` | Display version information. | 